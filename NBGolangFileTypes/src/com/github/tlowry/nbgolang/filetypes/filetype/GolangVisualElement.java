...
@MultiViewElement.Registration(
        ...
        position = 2000)
@Messages("LBL_Golang_VISUAL=Visual")
public final class GolangVisualElement extends JPanel implements MultiViewElement {

    private GolangDataObject obj;
    private JToolBar toolbar = new JToolBar();
    private transient MultiViewElementCallback callback;

    public GolangVisualElement(Lookup lkp) {
        obj = lkp.lookup(GolangDataObject.class);
        assert obj != null;
        initComponents();
    }

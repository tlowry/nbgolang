...
public final class OpenAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        FileChooserBuilder fcb = new FileChooserBuilder(com.github.tlowry.nbgolang.filetypes.filetype.actions.OpenAction.class);
        fcb.setApproveText("Open");
        fcb.setFileFilter(new GolangFileFilter());
    ...
    private final class GolangFileFilter extends FileFilter {
        ...
        public boolean accept(File pathname) {
            ...
            if (path[path.length - 1].equalsIgnoreCase("go")) {
                return true;
            }

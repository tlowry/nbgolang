...
@Messages({
    "LBL_Golang_LOADER=Files of Golang"
})
...
public class GolangDataObject extends MultiDataObject {

    public GolangDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        registerEditor(Globals.GOLANG_MIME_TYPE, true);
    }
    ...
    @MultiViewElement.Registration(
            ...
            preferredID = "Golang",
            position = 1000)
    @Messages("LBL_Golang_EDITOR=Source")

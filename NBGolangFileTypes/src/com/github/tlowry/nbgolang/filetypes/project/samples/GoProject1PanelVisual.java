...
public class GoProject1PanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private GoProject1WizardPanel panel;

    public GoProject1PanelVisual(GoProject1WizardPanel panel) {
        initComponents();
        this.panel = panel;
